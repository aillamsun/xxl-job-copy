		...
		while(!toStop){
            ...
            try {
				...
				if (triggerParam!=null) {
					...
					//设置分片信息	ShardingUtil.setShardingVo(new ShardingUtil.ShardingVO(triggerParam.getBroadcastIndex(), triggerParam.getBroadcastTotal()));
